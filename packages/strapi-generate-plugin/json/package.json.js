...
module.exports = scope => {
  ...
  return _.merge(scope.appPackageJSON || {}, {
    ...
    'scripts': {
      'analyze:clean': './node_modules/strapi-helper-plugin/node_modules/.bin/rimraf stats.json',
      ...
      'build:clean': './node_modules/strapi-helper-plugin/node_modules/.bin/rimraf admin/build',
      'start': 'cross-env NODE_ENV=development node ./node_modules/strapi-helper-plugin/lib/server',
      'generate': 'node ./node_modules/plop/plop.js --plopfile node_modules/strapi-helper-plugin/lib/internals/generators/index.js',
      'lint': './node_modules/strapi-helper-plugin/node_modules/.bin/eslint --ignore-path .gitignore --ignore-pattern \'/admin/build/\' --config ./node_modules/strapi-helper-plugin/lib/internals/eslint/.eslintrc.json admin',
      'prettier': './node_modules/strapi-helper-plugin/node_modules/.bin/prettier --single-quote --trailing-comma es5 --write "{admin,__{tests,mocks}__}/**/*.js"',
      'test': 'npm run lint',
